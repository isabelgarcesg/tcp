...
uint32_t counter =0; // vamos a enviar  contador dentro de payload 
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(nvs_flash_init()); // COMENTAR ESTAS
     ...
     */
    ESP_ERROR_CHECK(example_connect()); // CAMBIAR POR LA NUESTRA
    ...
    for(;;){
        ...
        counter++;
        sprintf(payload, "{\"contador\":%lu}",counter);
